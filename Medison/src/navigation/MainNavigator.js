...
function MainNavigator() {
  return (
    <MainStack.Navigator>
      ...
      <MainStack.Screen name="IrisScan" component={IrisScanScreen} options={{ title: "홍채 스캔"}}/>
      <MainStack.Screen name="IrisSuccess" component={IrisSuccessScreen} options={{ title: "홍채 스캔 성공"}}/>
      <MainStack.Screen name="IrisFail" component={IrisFailScreen} options={{ title: "홍채 스켄 실패"}}/>
